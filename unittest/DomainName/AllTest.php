 ...
 * 5. 异常测试：参数设置错误、缓存、等等
 */
class DomainNameAllTest
{
    public static function suite()
    {
        $suite = new PHPUnit_Framework_TestSuite('PHPUnit_Framework');

        $suite->addTestSuite('RightWayToUseDomainName');
        $suite->addTestSuite('WrongWayToUseDomainName');
        $suite->addTestSuite('PerformanceTuningDomainName');
